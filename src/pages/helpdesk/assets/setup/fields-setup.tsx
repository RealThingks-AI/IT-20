...
import { Plus, Pencil, Trash2, Building2, MapPin, FolderTree, Briefcase, Package, Loader2 } from "lucide-react";
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-3">
                <div>
                  ...
                  <CardDescription className="text-xs">Manage asset brands</CardDescription>
                </div>
